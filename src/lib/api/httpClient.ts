...
export type FetchesSearchParams = Record<string, boolean | number | string | string[] | null | undefined>;
...
export type SuccessRequestFun = (options: _RequestConfig) => _RequestConfig | Promise<_RequestConfig>;
...
export class Fetches {
  ...
  post<T, R = FetchesResponse<T>>(endpoint: string, body?: RequestBody, options: RequestOptions = {}) {
  ...
  put<T, R = FetchesResponse<T>>(endpoint: string, body?: RequestBody, options: RequestOptions = {}) {
  ...
  patch<T, R = FetchesResponse<T>>(endpoint: string, body?: RequestBody, options: RequestOptions = {}) {
